...
<%@ taglib prefix="orderclaim" tagdir="/WEB-INF/tags/addons/daimlerspmb2bacceleratoraddon/responsive/claim" %>

<form:form action="${request.contextPath}/my-account/order/${order.code}/claims/confirm"
           id="confirmreturnorderForm"
           commandName="orderEntryReturnForm"
           class="account-return-order-form">

    <orderclaim:claimCompleteOrder/>
    ...
    <ul class="item__list cart__list return-order__list">
        ...
        <li class="hidden-xs hidden-sm">
            <ul class="item__list--header">
                ...
                <li class="item__quantity"><spring:theme code="text.account.claim.qty"/></li>
            </ul>
        </li>
                ...
                <div class="row">
                    <div class="col-sm-6 col-sm-offset-6">
                        ...
                        <button type="submit" class="btn btn-primary btn-block" id="returnOrderButtonConfirmation"
                                disabled="disabled">
                            <spring:theme code="text.account.claim.submit"/>
                        </button>
