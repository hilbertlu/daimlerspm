...
import com.daimler.spm.b2bacceleratoraddon.forms.ReorderForm;
...
public class MyReplenishmentOrdersController extends AbstractSearchPageController
{
			...
			@RequestParam("productCode") final String productCode, final Model model)
	{
		...
		return Daimlerspmb2bacceleratoraddonControllerConstants.Views.Pages.Checkout.ReadOnlyExpandedOrderForm;
	}
}
