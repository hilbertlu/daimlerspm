 ...
 */
package com.daimler.spm.b2bacceleratoraddon.interceptors;


import de.hybris.platform.acceleratorstorefrontcommons.interceptors.BeforeViewHandler;
import com.daimler.spm.b2bacceleratoraddon.constants.Daimlerspmb2bacceleratoraddonConstants;
...
public class B2BAcceleratorAddonBeforeViewHandler implements BeforeViewHandler
{
			...
			throws Exception
	{
		...
		{
			modelAndView.setViewName(Daimlerspmb2bacceleratoraddonConstants.ADDON_PREFIX + viewMap.get(viewName).get(VIEW_NAME_MAP_KEY));
		}
	}
