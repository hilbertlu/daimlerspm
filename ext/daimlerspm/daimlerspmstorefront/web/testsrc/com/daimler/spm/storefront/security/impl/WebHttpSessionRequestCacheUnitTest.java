...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/daimlerspmstorefront/electronics/en",
						"https://electronics.local:9002/daimlerspmstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/daimlerspmstorefront/electronics/en",
						"https://electronics.local:9002/daimlerspmstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/daimlerspmstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/daimlerspmstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/daimlerspmstorefront/electronics/en",
						"https://electronics.local:9002/daimlerspmstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/daimlerspmstorefront",
						"https://electronics.local:9002/daimlerspmstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/daimlerspmstorefront",
						"https://electronics.local:9002/daimlerspmstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/daimlerspmstorefront/electronics/en",
						"https://electronics.local:9002/daimlerspmstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
