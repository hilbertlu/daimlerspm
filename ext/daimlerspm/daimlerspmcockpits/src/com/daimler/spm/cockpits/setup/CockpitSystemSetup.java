 ...
 */
package com.daimler.spm.cockpits.setup;
...
import com.daimler.spm.cockpits.constants.DaimlerspmCockpitsConstants;
 ...
 */
@SystemSetup(extension = DaimlerspmCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(DaimlerspmCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(DaimlerspmCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						DaimlerspmCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/daimlerspmcockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
