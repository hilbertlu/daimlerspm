 ...
 */
package com.daimler.spm.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(DaimlerspmFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(DaimlerspmFulfilmentProcessConstants.PARENT_PROCESS);
