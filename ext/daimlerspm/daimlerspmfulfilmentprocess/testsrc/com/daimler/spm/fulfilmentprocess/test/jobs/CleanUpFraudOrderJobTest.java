 ...
 */
package com.daimler.spm.fulfilmentprocess.test.jobs;
...
import com.daimler.spm.fulfilmentprocess.jobs.CleanUpFraudOrderJob;
...
public class CleanUpFraudOrderJobTest extends ServicelayerTransactionalTest
{
	...
	private static final String PROCESS_DEFINITION_NAME = DaimlerspmFulfilmentProcessConstants.ORDER_PROCESS_NAME;
