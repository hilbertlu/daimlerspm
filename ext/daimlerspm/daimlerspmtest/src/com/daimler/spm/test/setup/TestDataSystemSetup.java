 ...
 */
package com.daimler.spm.test.setup;
...
import com.daimler.spm.test.constants.DaimlerspmTestConstants;
import com.daimler.spm.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = DaimlerspmTestConstants.EXTENSIONNAME)
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			else
			{
				...
				importImpexFile(context, "/daimlerspmtest/import/qa-test-users.impex");

				LOG.info("Creating Reviews...");
				importImpexFile(context, "/daimlerspmtest/import/reviews.impex");
				...
				importImpexFile(context, "/daimlerspmtest/import/cstickets.impex");

				LOG.info("Creating Test Quotes...");
				importImpexFile(context, "/daimlerspmtest/import/csquotes.impex");
			}
		}
	}
}
